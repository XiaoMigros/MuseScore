...
PalettePtr PaletteCreator::newGuitarPalette(bool defaultPalette)
{
    ...
    static std::vector<PlayTechAnnotationInfo> playTechAnnotations = {
        { "distort",   PlayingTechniqueType::Distortion, },
        { "overdrive", PlayingTechniqueType::Overdrive, },
        { "harmonics", PlayingTechniqueType::Harmonics, },
        { "jazz tone", PlayingTechniqueType::JazzTone, },
        { "normal",    PlayingTechniqueType::Natural },
    };

    for (PlayTechAnnotationInfo playTechAnnotation : playTechAnnotations) {
        auto pta = makeElement<PlayTechAnnotation>(gpaletteScore);
        pta->setXmlText(QT_TRANSLATE_NOOP("palette", playTechAnnotation.xmlText));
