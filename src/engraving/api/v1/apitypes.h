...
enum class ElementType {
    ...
    FRET_CIRCLE           = int(mu::engraving::ElementType::FRET_CIRCLE),
...
enum class TextPlace {
    ...
    DOWN  = int(mu::engraving::TextPlace::DOWN),
};
Q_ENUM_NS(TextPlace);
...
enum class Anchor {
    SEGMENT = int(mu::engraving::SpannerAnchor::SEGMENT),
    MEASURE = int(mu::engraving::SpannerAnchor::MEASURE),
    CHORD   = int(mu::engraving::SpannerAnchor::CHORD),
    NOTE    = int(mu::engraving::SpannerAnchor::NOTE),
};
Q_ENUM_NS(Anchor);
...
enum class ClefType {
    ...
    G4_8VB     = int(mu::engraving::ClefType::G4_8VB),
...
enum class BracketType {
    ...
    INE        = int(mu::engraving::BracketType::INE),
...
enum class ArticulationTextType {
    ...
    TAP     = int(mu::engraving::ArticulationTextType::TAP),
