...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::frenchStyleBeams,        "frenchStyleBeams",        false },
    ...
    { Sid::fretNumMag,              "fretNumMag",              PropertyValue(2.0) }, // DEPRECATED
    ...
    { Sid::skylineMinHorizontalClearance, "skylineMinHorizontalClearance", Spatium(0.25) },
    ...
    { Sid::mmRestRangePosBelow,           "mmRestRangePosBelow",          PointF(0.0, 1.0) },
    ...
    { Sid::staffTextOffsetType,           "staffTextOffsetType",          int(OffsetType::SPATIUM) },
    ...
    { Sid::fretDiagramFingeringColor,                "fretDiagramFingeringColor",              PropertyValue::fromValue(Color::BLACK) },
    { Sid::fretDiagramFingeringAlign,                "fretDiagramFingeringAlign",              Align(AlignH::LEFT, AlignV::BASELINE) },
    { Sid::fretDiagramFingeringPosAbove,             "fretDiagramFingeringPosAbove",           PointF(.0, -1.0) },
    { Sid::fretDiagramFingeringFrameType,            "fretDiagramFingeringFrameType",          int(FrameType::NO_FRAME) },
    { Sid::fretDiagramFingeringFramePadding,         "fretDiagramFingeringFramePadding",       0.2 },
    { Sid::fretDiagramFingeringFrameWidth,           "fretDiagramFingeringFrameWidth",         0.1 },
    { Sid::fretDiagramFingeringFrameRound,           "fretDiagramFingeringFrameRound",         0 },
    { Sid::fretDiagramFingeringFrameFgColor,         "fretDiagramFingeringFrameFgColor",       PropertyValue::fromValue(Color::BLACK) },
    ...
    { Sid::fretDiagramFretNumberColor,                "fretDiagramFretNumberColor",              PropertyValue::fromValue(Color::BLACK) },
    { Sid::fretDiagramFretNumberAlign,                "fretDiagramFretNumberAlign",              Align(AlignH::LEFT, AlignV::BASELINE) },
    { Sid::fretDiagramFretNumberPosAbove,             "fretDiagramFretNumberPosAbove",           PointF(.0, -1.0) },
    { Sid::fretDiagramFretNumberFrameType,            "fretDiagramFretNumberFrameType",          int(FrameType::NO_FRAME) },
    { Sid::fretDiagramFretNumberFramePadding,         "fretDiagramFretNumberFramePadding",       0.2 },
    { Sid::fretDiagramFretNumberFrameWidth,           "fretDiagramFretNumberFrameWidth",         0.1 },
    { Sid::fretDiagramFretNumberFrameRound,           "fretDiagramFretNumberFrameRound",         0 },
    { Sid::fretDiagramFretNumberFrameFgColor,         "fretDiagramFretNumberFrameFgColor",       PropertyValue::fromValue(Color::BLACK) },
    { Sid::fretDiagramFretNumberFrameBgColor,         "fretDiagramFretNumberFrameBgColor", PropertyValue::fromValue(Color::transparent) },
