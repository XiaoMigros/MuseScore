...
InspectorPropertyView {
    ...
    FocusableItem {
        ...
        StyledGridView {
            ...
            model: RestVisualDurationModel {
                id: restVisualDurationModel
            }
            ...
            delegate: ListItemBlank {
                ...
                StyledIconLabel {
                    ...
                    iconCode: index != 0 ? model.iconCode : null
					//text: index == 0 ? qsTrc("inspector", "Auto")
                }

                onClicked: {
                    if (root.propertyItem) {
                        root.propertyItem.value = model.restVisualDuration
                    }
                }
            }
