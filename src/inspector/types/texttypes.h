...
static const QList<mu::engraving::ElementType> TEXT_ELEMENT_TYPES = {
    ...
    // TextLines
    mu::engraving::ElementType::TEXTLINE,
    mu::engraving::ElementType::TEXTLINE_SEGMENT,
    mu::engraving::ElementType::VOLTA,
    mu::engraving::ElementType::VOLTA_SEGMENT,
    mu::engraving::ElementType::OTTAVA,
    mu::engraving::ElementType::OTTAVA_SEGMENT,
    //mu::engraving::ElementType::GLISSANDO,
    //mu::engraving::ElementType::GLISSANDO_SEGMENT,
    mu::engraving::ElementType::PEDAL,
    mu::engraving::ElementType::PEDAL_SEGMENT,
    //mu::engraving::ElementType::GUITAR_BEND,
   // mu::engraving::ElementType::GUITAR_BEND_SEGMENT,
    mu::engraving::ElementType::LET_RING,
    mu::engraving::ElementType::LET_RING_SEGMENT,
    mu::engraving::ElementType::PALM_MUTE,
    mu::engraving::ElementType::PALM_MUTE_SEGMENT,
    mu::engraving::ElementType::HAIRPIN,
    ...
    mu::engraving::ElementType::WHAMMY_BAR,
    mu::engraving::ElementType::WHAMMY_BAR_SEGMENT,
    mu::engraving::ElementType::PICK_SCRAPE,
    mu::engraving::ElementType::PICK_SCRAPE_SEGMENT,
    mu::engraving::ElementType::RASGUEADO,
    mu::engraving::ElementType::RASGUEADO_SEGMENT,
    mu::engraving::ElementType::HARMONIC_MARK,
    mu::engraving::ElementType::HARMONIC_MARK_SEGMENT,
};
}
