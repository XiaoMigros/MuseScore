...
TDuration musxDurationInfoToDuration(musx::dom::Duration noteInfo)
{
...
Fraction simpleMusxTimeSigToFraction(const std::pair<musx::util::Fraction, musx::dom::NoteType>& simpleMusxTimeSig,
