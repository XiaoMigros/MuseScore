...
public:
    ...
    MOCK_METHOD(EngravingItem*, hitElement, (const muse::PointF&, float, bool), (const, override));
    MOCK_METHOD(EngravingItem*, hitSubElement, (const muse::PointF&, float), (const, override));
    MOCK_METHOD(std::vector<EngravingItem*>, hitElements, (const muse::PointF&, float, bool), (const, override));
